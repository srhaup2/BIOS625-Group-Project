...
save(DTM, data, processedCorpus, file = "DTM_preprocessing.dta")
```
...
#save(topicModel, file = "topicModel_preprocessing.dta")
...
# write to CSV file
write.csv(data[, c(1:7, 16, 8:15, 18:19, 17)], file = "answers_topics.csv", row.names = FALSE)
```
